...
survey.onComplete.add(function (resultdata) {
    result = resultdata.data
  
       localStorage.calm = result.neuroticism
       localStorage.anxious = result.neuroticism_r
       localStorage.critical = result.agreeableness_r
       localStorage.warm = result.agreeableness
       localStorage.creative = result.openness
       localStorage.conventional = result.openness_r
       localStorage.extroverted = result.extraversion
       localStorage.reserved = result.extraversion_r
       localStorage.dependable = result.conscientiousness
       localStorage.careless = result.conscientiousness_r
...
//        document.querySelector('#surveyResult').innerHTML = "From the way you answered the questions, you seem to describe yourself as someone who is energetic and active. Your answers describe you as someone who has the following traits";
        var result_page = window.open('C:/Users/Vinita/Desktop/mineuser/quizapp/results.html',"_self");


        // Access it using its variable
       
        //window.location.href="/C:/Users/Vinita/Desktop/mineuser/quizapp/results.html";
        // printResult(result.data);//change this
